            ...
            style={
              {
                ...
                "--sidebar-width-chat": SIDEBAR_WIDTH_CHAT,
      ...
      >
        ...
        <div
          className={cn(
            ...
            "w-[--sidebar-width]",
            "group-data-[chat-active=true]/sidebar:w-[--sidebar-width-chat]",
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] ease-linear md:flex",
            "group-data-[chat-active=true]/sidebar:w-[--sidebar-width-chat]",
            side === "left"
